// Code mainly adapted from https://github.com/googlesamples/android-play-places/blob/master/PlaceCompleteAdapter/Application/src/main/java/com/example/google/playservices/placecomplete/MainActivity.java
...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextView = (AutoCompleteTextView) findViewById(R.id.searchPlaces);
        ...
        // Make the action bar conform to material design
        android.support.v7.app.ActionBar supportActionBar = getSupportActionBar();
        supportActionBar.setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(this, R.color.primary)));
        supportActionBar.setTitle(Html.fromHtml("<font color='#FFFFFF'>Coding Assignment</font>"));
    }
    ...
    private ResultCallback<PlaceBuffer> updatePlaceDetailsCallback
        ...
        public void onResult(PlaceBuffer places) {
            if (!places.getStatus().isSuccess()) {
                ...
                Toast.makeText(getApplicationContext(), "Place query did not complete. Error: " + places.getStatus().toString(),
